...
- **TEC-35 (#175)** — Scaffold `.claude-plugin/` manifest + own marketplace entry. ✅ Landed: `.claude-plugin/plugin.json` + `.claude-plugin/marketplace.json` (plugin runs `npx -y tech-debt-mcp`, repo doubles as its own marketplace).
