...
### Added
- **Privacy policy** (TEC-44, #183, closes #33) — new `PRIVACY.md` at repo root and a hosted mirror at <https://pierrejanineh.github.io/TechDebtMCP/privacy> covering data handling, telemetry posture, and third-party services. README gains a Privacy section linking to both. The hosted URL is the stable link for the Anthropic MCP directory submission form (TEC-45).
