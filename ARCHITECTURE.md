...
- Custom Rules (Phase 5): `add_custom_rule`, `remove_custom_rule`, `list_session_custom_rules` (renamed from `list_custom_rules` in v2.0.3 / TEC-51), `execute_custom_rules`, `validate_custom_pattern`
